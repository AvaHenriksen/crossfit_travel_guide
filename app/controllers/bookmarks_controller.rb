class BookmarksController < ApplicationController
  ...
  def index
    ...
    @bookmarks = @q.result(:distinct => true).includes(:user, :box, :food_option).page(params[:page]).per(10)
  ...
  def create
    ...
    @bookmark.box_id = params[:box_id]
    @bookmark.food_option_id = params[:food_option_id]
